  ...
  return (
    <div className="u-pageContact md:ml-[185px] md:mr-20">
      ...
      <form onSubmit={handleSubmit} className="p-4 max-w-4xl mx-auto my-10 md:my-20 space-y-8 px-5 md:px-0">
        {/* ご用件ラジオボタン */}
        <fieldset className="mb-6 md:flex gap-6 border-b border-pana-gray02 pb-6 md:border-none md:pb-0">
        ...
        {/* 貴社名 */}
        <div className="md:flex items-center gap-6 border-b border-pana-gray02 pb-8 md:border-none md:pb-0">
          <label htmlFor="company" className="w-full md:w-[220px] shippori text-lg font-medium">
            貴社名
          </label>
          <input
            id="company"
