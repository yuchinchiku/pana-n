  ...
  return (
    <div className='u-pageHealing md:ml-[185px] md:mr-20'>
      ...
      <PageIntro
        ...
        desc={
          `<p>ただ身体をほぐすだけのものではなく、<br class='hidden md:block' />深く静かに、心や魂にふれるもの。</p>
          <p> パナ・ンでは、単なるテクニックを超えた、<br class='hidden md:block' />
          沖縄の伝統的な知恵に根ざし、<br class='hidden md:block' />
          より本質的な魂の回復と変容を追求しています あなたの内なる輝きを呼び覚ます深遠な癒しの旅。</p>
          <p>一人一人の物語に寄り添い、本来の自分を取り戻す<br class='hidden md:block' />
          パナ・ンでの癒しを紹介します。</p>`}
      />
      <section className='mt-20'>
        <PageSecTitle
          ...
          desc={
            `<p>パナ・ンは、琉球の伝統と沖縄の自然に敬意を払い、<br class='hidden md:block' />心と身体に深く寄り添う「本質的な癒し」を大切にしています。</p>
            <p>訪れるお客様一人一人の心と体に寄り添い、丁寧に、誠実に——。</p>
            <p>ただほぐすだけのものではなく、<br class='hidden md:block' />
      ...
      <section>
        <PageSecTitle
          ...
          desc={
            `<p>パナ・ンでは、沖縄の自然と文化を活かした<br class='hidden md:block' />パナ・ン独自のオリジナルの癒しをご用意しています。</p>
            <p>店舗ごとに異なる手技や素材を取り入れ、<br class='hidden md:block' />琉球空手と八重山舞踊を融合した元祖琉球マッサージ「琉球ほぐし手」や<br class='hidden md:block' />珊瑚、ゴーヤー、黒糖、モズク、クチャなど、<br class='hidden md:block' />こだわりの琉球粧材を使用したメニュー。</p>
      ...
      <section className='my-20 md:my-40'>
        <PageSecTitle
          ...
          desc={
            ...
            <p>海の恵み、島の植物、太陽のエネルギーを取り入れた「ぬちぐすい（命の薬）」で、<br class='hidden md:block' />
