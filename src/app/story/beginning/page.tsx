...
const StoryList: Story[] = [
  {
    ...
    num: '01',
    title: '「パナ・ン」という名前の由来',
    desc: '<p>「パナ」 八重山方言（ヤイマムニ）で「花」<br />「ン」 原点であり、新たな始まりを告げる言葉 </p><p>常に新しい可能性へと続いていくお花のように、沖縄の伝統を受け継いで、未来に渡していきたい。<br />沖縄の先祖から受け継いだ癒しを、世界に花開かせたいという、深い願いを胸に。</p><p>ここに、パナ・ンの、そして私たちの物語が始まります。</p>',
  },
  {
    pageName: 'beginning',
    num: '02',
    title: '「パナ（花）」のように咲き、次の世代へ伝えていく',
    desc: '<p>人から見られて「かわいいね」と言われる花もあれば、山の奥や崖の上など、誰にも見られなくても一生懸命咲く花もあるでしょう。</p><p>花は、桜、ひまわり、たんぽぽ、どんな花でも皆一生懸命咲き、自分の証を残し、次の世代に種として伝えていきます。<br />この姿は人間も企業も全て同じだと考えています。</p><p>黄色、赤、白、それぞれ色で自分らしく咲く花のように、一人一人の人が夢を持って一生懸命咲いて、次に伝えていくこと。<br />これが私たちの哲学です。</p>',
  },
  {
    pageName: 'beginning',
    num: '03',
    title: '大きく咲き、集う人々に幸せを分かち合う場所として',
    desc: '<p>「私たちの周りに集う全ての人々に、豊かな幸せを分かち与えたい」</p><p>私たちパナ・ンは、大きく咲いて多くの命を支える花のように、様々な想いを集め、集う人々に幸せを分かち合える場所作りに心掛けています。</p><p>「集まる人々が自分らしく」</p><p>ここに集うすべての人が、自分らしく輝き咲くことを願っています。<br />一生懸命に、そして自分らしく咲き誇る場所でありたい。<br />これが「パナ・ン」の想いです。</p><p>「みんなで幸せになろう」<br /> 「集う人々に幸せを分かち合う」<br />その想いで、私たちパナ・ンは、毎日人と人との繋がりと絆を大切にしています。</p>',
  },
];
