...
const StoryList: Story[] = [
  ...
  },
  {
    ...
    <p class='pt-6'>そこでパナ・ンは、琉球にちなんだ「技」を「琉球元祖マッサージ」といった独自の技術の中に落とし込み、日々研究してきました。</p>
    <p>琉球元祖マッサージとは、琉球空手の技と琉球舞踊（宮廷舞踊）・八重山舞踊（生活に密着した農耕舞踊）の手の舞を取り入れた秘伝のマッサージです。</p>
