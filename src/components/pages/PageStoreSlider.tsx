...
export default function PageStoreSlider() {
  ...
  return (
    <div className="u-pageSlider mx-auto my-20 md:mt-0 md:mb-40 pl-5 md:px-0">
      <div className="u-lineTitle u-fade-in flex items-center gap-2 md:gap-4 mb-10 md:mx-[11%] pr-5 md:pr-0 ">
