...
export default function StoreGallery({ store }: Props) {
  ...
  return (
    <section className="u-gallery mx-auto my-10 lg:my-32">
      <div className="u-gallery-wrapper lg:flex flex-wrap gap-4">
        {store.gallery.map((img, idx) => {
          // 縦長・横長で幅を変える
          const widthClass = img.type === "portrait" ? "w-[51.7%] lg:w-[34%]" : "w-[76%] lg:w-[51%]";
          const heightClass = img.type === "portrait" ? "h-[291px] lg:h-[587px]" : "h-[190px] lg:h-[418px]";
