...
export default function Hero() {
  return (
    <div className="u-hero relative w-full h-screen">
      <video
      ...
      <h1 className="u-hero-lead fixed shippori text-xl text-white md:text-4xl">
      ...
      <div className='u-scroll fixed bottom-24 left-1/2 -translate-x-1/2'>
