...
export default function Intro() {
  ...
  return (
    <section className="u-intro sec-white relative shippori text-base w-full lg:text-lg font-medium tracking-[2px] z-10 pt-40 lg:mt-[200px] lg:pt-[320px] lg:pb-40 lg:pl-[180px] lg:pr-20" data-header-color="#1D1112">
      <div className="relative lg:flex lg:justify-center lg:gap-12 lg:flex-row-reverse">
        <div className="u-intro-textBlock relative writing-vertical mr-[10.6%] ml-auto lg:mx-0">
          ...
          <div ref={deigo1Ref} className="u-ill-deigo-1 w-[70px] lg:w-[115px] h-[145px] lg:h-[239px] absolute -top-4 lg:top-[-47px] -left-24 lg:right-[-158px] lg:left-auto">
            <Image src='/images/top/deigo-1.svg' alt='' fill className='object-cover' sizes="(max-width: 768px) 70px, 115px" priority />
          </div>
        </div>

        <div className="u-intro-textBlock relative writing-vertical ml-[10.6%] mr-auto mt-5 lg:mx-0 lg:mt-0">
          ...
          <div ref={line1SpRef} className="u-ill-line-1 absolute -top-24 left-[44%] lg:hidden">
        ...
        <div ref={line1PcRef} className="u-ill-line-1 absolute lg:top-40 hidden lg:block" style={{ pointerEvents: 'none' }}>
      ...
      <div className="relative my-20 lg:flex lg:justify-center lg:gap-12 lg:flex-row-reverse lg:my-36">
        <div className="u-intro-textBlock relative writing-vertical mr-[10.6%] ml-auto lg:mx-0">
          ...
          <div ref={deigo2Ref} className="u-ill-deigo-2 w-[200px] h-[157px] absolute -top-52 -right-8 lg:hidden">
            <Image src='/images/top/deigo-2.svg' alt='' fill className='object-cover' sizes="200px" priority />
          </div>
          <div ref={line2SpRef} className="u-ill-line-2 absolute -top-10 -left-24 lg:hidden">
        ...
        <div className="u-intro-textBlock relative writing-vertical ml-[10.6%] mr-auto mt-5 lg:mx-0 lg:mt-0">
          ...
          <div ref={deigo3PcRef} className="u-ill-deigo-2 hidden lg:block lg:w-[320px] lg:h-[248px] absolute lg:top-4 lg:left-[-320px]">
      ...
      <div className="relative lg:flex lg:justify-center lg:gap-12 lg:flex-row-reverse">
        ...
        <div className="u-intro-textBlock writing-vertical ml-[10.6%] mr-auto -mt-4 lg:mx-0 lg:mt-0">
        ...
        <div ref={line2PcRef} className="u-ill-line-2 absolute lg:-top-40 hidden lg:block">
